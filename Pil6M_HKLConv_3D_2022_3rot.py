...
nxsetmemory(100000)
stack_names = sorted([workingdir+f for f in os.listdir(workingdir) if f.startswith("stack")])
stack1,stack2,stack3 = [nxload(stack_name) for stack_name in stack_names]
