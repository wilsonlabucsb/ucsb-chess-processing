...
def call_get_peaklist():
    ...
    if is_sure:
        ...
        get_peaklist(folder_path, value_min, value_max, lower_bound_value, upper_bound_value)
...
entry_path = tk.Entry(root, textvariable=orm_folder, state='readonly', width=40)
...
existing_peaklist_label = tk.Label(root, text="")
existing_peaklist_label.grid(row=row, column=0, columnspan=2, pady=10, padx=5, sticky=tk.W)
row+=1

# Add a horizontal Separator
separator_horizontal1 = ttk.Separator(root, orient="horizontal")
...
tk.Entry(root, textvariable=lower_bound, width=10).grid(row=row, column=1, pady=5, padx=5, sticky=tk.W)
row+=1

tk.Label(root, text="Maximum # peaks:").grid(row=row, column=0, pady=5, padx=5, sticky=tk.E)
upper_bound = tk.DoubleVar(value=150)
tk.Entry(root, textvariable=upper_bound, width=10).grid(row=row, column=1, pady=5, padx=5, sticky=tk.W)
row+=1

tk.Label(root, text="Minimum intensity (%):").grid(row=row, column=0, pady=5, padx=5, sticky=tk.E)
val_min = tk.DoubleVar(value=0.9)
tk.Entry(root, textvariable=val_min, width=10).grid(row=row, column=1, pady=5, padx=5, sticky=tk.W)
row+=1

tk.Label(root, text="Maximum intensity (%):").grid(row=row, column=0, pady=5, padx=5, sticky=tk.E)
val_max = tk.DoubleVar(value=1.0)
tk.Entry(root, textvariable=val_max, width=10).grid(row=row, column=1, pady=5, padx=5, sticky=tk.W)
row+=1

# Create button to call get_peaklist function
get_peaklist_button = tk.Button(root, text="Generate new peaklist", command=call_get_peaklist)
...
num_peaks_label = tk.Label(root, text="")
num_peaks_label.grid(row=row, column=0, columnspan=2, pady=10, padx=5, sticky=tk.W)
row+=1

# Add a horizontal Separator
separator_horizontal2 = ttk.Separator(root, orient="horizontal")
separator_horizontal2.grid(row=row, column=0, columnspan=3, sticky="ew", pady=10)
row += 1
...
browse_button = tk.Button(root, text="Browse for Unit Cell Parameters", command=get_cell_params_from_file)
browse_button.grid(row=row, column=0, pady=10, padx=5)
row+=1

# Entry boxes for unit cell parameters
tk.Label(root, text="a").grid(row=row, column=0, padx=5, sticky=tk.E)
uca_entry = tk.Entry(root, textvariable=uca_var, width=10)
uca_entry.grid(row=row, column=1, padx=5, sticky=tk.W)
row += 1

tk.Label(root, text="b").grid(row=row, column=0, padx=5, sticky=tk.E)
ucb_entry = tk.Entry(root, textvariable=ucb_var, width=10)
ucb_entry.grid(row=row, column=1, padx=5, sticky=tk.W)
row += 1

tk.Label(root, text="c").grid(row=row, column=0, padx=5, sticky=tk.E)
ucc_entry = tk.Entry(root, textvariable=ucc_var, width=10)
ucc_entry.grid(row=row, column=1, padx=5, sticky=tk.W)
row += 1

tk.Label(root, text="alpha").grid(row=row, column=0, padx=5, sticky=tk.E)
ucal_entry = tk.Entry(root, textvariable=ucal_var, width=10)
ucal_entry.grid(row=row, column=1, padx=5, sticky=tk.W)
row += 1

tk.Label(root, text="beta").grid(row=row, column=0, padx=5, sticky=tk.E)
ucbe_entry = tk.Entry(root, textvariable=ucbe_var, width=10)
ucbe_entry.grid(row=row, column=1, padx=5, sticky=tk.W)
row += 1

tk.Label(root, text="gamma").grid(row=row, column=0, padx=5, sticky=tk.E)
ucga_entry = tk.Entry(root, textvariable=ucga_var, width=10)
ucga_entry.grid(row=row, column=1, padx=5, sticky=tk.W)
row += 1

# Button to get unit cell parameters from entry boxes
get_params_button = tk.Button(root, text="Save unit cell parameters", command=get_cell_params_from_entry)
get_params_button.grid(row=row, column=0, pady=10)
row+=1

# Add a label to confirm uc parameters
uc_saved_label = tk.Label(root, text="")
uc_saved_label.grid(row=row, column=0, columnspan=2, pady=10, padx=5, sticky=tk.W)
row+=1

# Add a horizontal Separator
separator_horizontal3 = ttk.Separator(root, orient="horizontal")
